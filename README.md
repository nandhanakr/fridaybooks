...
Developed a scalable backend infrastructure with Python and Django, handling everything from user authentication to order management with efficiency and reliability.

📁 Database : 
Implemented a secure and reliable MySQL database to store and organize product listings, user profiles, and transaction data, ensuring seamless data management and retrieval.

💳 Payment Integration : 
With the integration of Instamojo API, simplified the checkout process, allowing for secure and hassle-free transactions.
